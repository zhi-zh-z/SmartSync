 ...
 *
 */
#if defined(CONFIG_EXAMPLE_LVGL_PORT_BUF_PSRAM)
#define LVGL_PORT_BUFFER_MALLOC_CAPS    (MALLOC_CAP_SPIRAM)
#elif defined(CONFIG_EXAMPLE_LVGL_PORT_BUF_INTERNAL)
#define LVGL_PORT_BUFFER_MALLOC_CAPS    (MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT)
#else
#define LVGL_PORT_BUFFER_MALLOC_CAPS    (MALLOC_CAP_SPIRAM) // Default to PSRAM if not set
#endif

#if defined(CONFIG_EXAMPLE_LVGL_PORT_BUF_HEIGHT)
#define LVGL_PORT_BUFFER_HEIGHT         (CONFIG_EXAMPLE_LVGL_PORT_BUF_HEIGHT)
#else
#define LVGL_PORT_BUFFER_HEIGHT         (120) // Default to 120 lines
#endif
 ...
 *
 */
#define LVGL_PORT_PPA_ROTATION_ENABLE   (1)
